...
urlpatterns = [
    path('', views.home),
    path("show_all_projects", csrf_exempt(views.show_all_project), name="show_all_projects"),
    ...
    path("show_all_topics", csrf_exempt(views.show_all_topics), name="show_all_topics"),
]